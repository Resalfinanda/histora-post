...
export function TrendingSearchTopics({ topics }: TrendingSearchProps) {
  ...
  const defaultTopics: TrendingSearchTopic[] = [
    { id: "1", term: "Teknologi", count: 1250 },
    { id: "2", term: "Politik", count: 980 },
    { id: "3", term: "Olahraga", count: 750 },
    { id: "4", term: "Hiburan", count: 620 },
    { id: "5", term: "Kesehatan", count: 480 },
  ];

  const displayTopics = topics || defaultTopics;

  return (
    <section className="bg-linear-to-r from-blue-50 to-blue-100 rounded-lg p-6">
